...
struct ROUTING_TABLE_ENTRY {
    ...
    void print() const {
        ...
        cout << "Routing entry: " << "destAddr: " << destAddr << ", intermediateAddr: " << intermediateAddr << ", seqNum: " << seqNum << ", cost: " << cost << ", ttl: " << ttl_seconds << " seconds, tesla_hash: " << tesla_hash << ", tesla_disclosure_time: " << tesla_disclosure_time.count() << " seconds, hash: ";
